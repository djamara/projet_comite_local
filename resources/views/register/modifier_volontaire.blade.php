                    ...
                    <div class="col-sm-12 ">
                        ...
                        <div class="wizard-container">
                            <div class="card wizard-card" data-color="red" id="wizardProfile">
                                <form action="/modifierFormVolontaire" method="POST" id="formInscript" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="{{ $volontaire->personne_immat }}" name="matricule" id="matricule" type="text" class="form-control" placeholder="Entrez votre matricule" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="paysNationnalite" class="form-control selectpicker" data-style="btn btn-link" name="comite" required>
                                                            ...
                                                            foreach ($comites as $comite): ?>
                                                                <option value="<?php echo $comite['idcomite']?>" <?php if($volontaire->comiteActuel == $comite['idcomite'] ) { echo "selected" ;}?> >
                                                                    <?php echo $comite['comite_libelle']?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="paysNationnalite" class="form-control selectpicker" data-style="btn btn-link" name="fonctionCR" required>
                                                            ...
                                                            foreach ($fonctions as $fonction): ?>
                                                                <option value="<?php echo $fonction['idfonctionCR']?>" <?php if($volontaire->fonctionCR_idfonctionCR == $fonction['idfonctionCR'] ) { echo "selected" ;}?> >
                                                                    <?php echo $fonction['fonctionCR_libelle']?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="{{ $volontaire->personne_nom }}" name="nomVolontaire" id="nomVolontaire" type="text" class="form-control" placeholder="Entrez votre nom" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label class="control-label">Prénom(s) <small class="text-danger">*</small></label>
                                                        <input value="{{ $volontaire->personne_prenom }}" name="prenomVolontaire" id="prenom" placeholder="Entrez vos prénoms" type="text" class="form-control" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="{{ $volontaire->personne_date_naiss }}" id="dateNaissance" name="dateNaissVolontaire" type="date" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control selectpicker" name="civilite" data-style="btn btn-link" id="sexe" required>
                                                            <option value="Mr" <?php if($volontaire->personne_civilite == "Mr" ) { echo "selected" ;}?> >Mr</option>
                                                            <option value="Mlle" <?php if($volontaire->personne_civilite == "Mlle" ) { echo "selected" ;}?> >Mlle</option>
                                                            <option value="Mme" <?php if($volontaire->personne_civilite == "Mme" ) { echo "selected" ;}?> >Mme</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4"></div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control selectpicker" name="sitMatrimonial" data-style="btn btn-link" id="sitMatrimonial" required>
                                                            <option></option>
                                                            <option value="0" <?php if($volontaire->personne_situation_mat == "0" ) { echo "selected" ;}?> >Celibataire</option>
                                                            <option value="1" <?php if($volontaire->personne_situation_mat == "1" ) { echo "selected" ;}?> >Marié(e)</option>
                                                            <option value="2" <?php if($volontaire->personne_situation_mat == "2" ) { echo "selected" ;}?> >Veuf(ve)</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="paysNationnalite" name="vilNaiss" class="form-control selectpicker" data-style="btn btn-link" required>
                                                            ...
                                                            foreach ($villes as $ville): ?>
                                                                <option value="<?php echo $ville['VIL_IDENTIFIANT']?>" <?php if($volontaire->personne_ville_naiss == $ville['VIL_IDENTIFIANT'] ) { echo "selected" ;}?> >
                                                                    <?php echo $ville['VIL_NOM']?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="paysNationnalite" name="comNaiss" class="form-control selectpicker" data-style="btn btn-link" required >
                                                            ...
                                                            foreach ($communes as $commune): ?>
                                                                <option value="<?php echo $commune['idcommune']?>" <?php if($volontaire->personne_commune_naiss == $commune['idcommune'] ) { echo "selected" ;}?> >
                                                                    <?php echo $commune['commune_libelle']?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="{{ $volontaire->lieuDeNaissance }}" id="commune" name="lieuDeNaissance" placeholder="Entrer la commune ou le quartier" type="text" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="paysNationnalite" name="nationalite" class="form-control selectpicker" data-style="btn btn-link">
                                                            ...
                                                            foreach ($paysNationalite as $pays): ?>
                                                                <option value="<?php echo $pays['PAYS_CODE']?>" <?php if($pays['PAYS_CODE'] == $volontaire->personne_pays_nationalite ){ echo "selected" ;} ?> >
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control selectpicker" name="typePiece" data-style="btn btn-link" id="typePiece">
                                                            ...
                                                            <option value="<?php echo $typePiece['idTypePiece']?>" <?php if($typePiece['idTypePiece'] == $volontaire->TypePiece ){ echo "selected" ;} ?> >
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="{{ $volontaire->NumerPiece }}" id="numPiece" name="numPieceVolontaire" placeholder="Entrez le numero de la pièce" type="text" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control selectpicker" name="groupeSanguin" data-style="btn btn-link" id="groupeSanguin">
                                                            ...
                                                            <?php foreach ($groupesanguin as $groupesanguin):?>
                                                                <option value="<?php echo $groupesanguin['idGroupeSanguin']?>" <?php if($groupesanguin['idGroupeSanguin'] == $volontaire->groupeSanguin ){ echo "selected" ;} ?> >
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="paysNationnalite" name="vilHabitVolontaire" class="form-control selectpicker" data-style="btn btn-link" required>
                                                            ...
                                                            <?php //$villes = getAllTable('villes');
                                                            foreach ($villes as $ville): ?>
                                                                <option value="<?php echo $ville['VIL_IDENTIFIANT']?>" <?php if($ville['VIL_IDENTIFIANT'] == $volontaire->personne_ville_habitation ){ echo "selected" ;} ?> >
                                                                    <?php echo $ville['VIL_NOM']?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="paysNationnalite" name="comHabitVolontaire" class="form-control selectpicker" data-style="btn btn-link" required>
                                                            ...
                                                            <?php //$communes = getAllTable('commune');
                                                            foreach ($communes as $commune): ?>
                                                                <option value="<?php echo $commune['idcommune']?>" <?php if($commune['idcommune'] == $volontaire->personne_commune_habitation ){ echo "selected" ;} ?> >
                                                                    <?php echo $commune['commune_libelle']?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="{{ $volontaire->codepostale }}" name="codepostale" id="codePostale" placeholder="Entrez le code postale" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="{{ $volontaire->personne_quartier_habitation }}" id="lieuHabitation" name="lieuHabitation" placeholder="Entrer la commune ou le quartier" type="text" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="{{ $volontaire->personne_telephone_3 }}" name="tel3Volontaire" id="tel3Volontaire" placeholder="Entrez le numéro de téléphone fixe" type="text" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label class="control-label">Téléphone mobile money <small class="text-danger">*</small></label>
                                                        <input value="{{ $volontaire->personne_telephone_2 }}" name="tel2Volontaire" id="telportAdrGeo" placeholder="Entrez le numéro de téléphone portable" type="text" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label class="control-label">Email <small class="text-danger">*</small></label>
                                                        <input value="{{ $volontaire->personne_email }}" name="emailVolontaire" id="emailAdrGeo" placeholder="Entrez l'adresse email" type="email" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label class="control-label">Numéro WhatsApp <!--<small class="text-danger">*</small>--></label>
                                                        <input value="{{ $volontaire->personne_telephone_1 }}" name="tel1Volontaire" id="tel1Volontaire" placeholder="Entrez le numéro WhatsApp" type="text" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                        ...
                                                        <!-- <select class="select2 form-control selectpicker" data-style="btn btn-link" id="diplomeInfoPers">
                                                         ...
                                                         <label class="checkbox-inline">
                                                            ...
                                                            <?php foreach ($diplomes as $diplome):?>
                                                                <label class="checkbox-inline">
                                                                    <input type="checkbox" name="diplomes[]" id="" value="<?php echo $diplome['iddiplome']?>" <?php if( in_array($diplome['iddiplome'] , $diplomes_personne) ){ echo "checked" ; }?> >
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input value={{ $volontaire->personne_niveau_etude }} name="niveauEtudeInfoPers" id="niveauEtudeInfoPers" placeholder="Ex: Bac+2" type="text" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="paysNationnalite" name="profession" class="form-control selectpicker" data-style="btn btn-link">
                                                            <?php //var_dump($volontaire->profession_idprofession) ?>
                                                            <option></option>
                                                            <?php
                                                            foreach ($professions as $profession): ?>
                                                                <option value="<?php echo $profession['idprofession']?>" <?php if($profession['idprofession'] == $volontaire->profession_idprofession){ echo "selected" ;}?> >
                                                                    <?php echo $profession['profession_libelle']?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="{{ $volontaire->personne_qualification }}" name="qualifVolontaire" id="qualifProfInfoPers" placeholder="Entrez la qualification professionnelle" type="text" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div id="panelPrecisionActivite">
                                                            ...
                                                            <input value="{{ $volontaire->personne_activite }}" name="activiteVolontaire" id="activiteInfoPers" placeholder="Renseigner la/les activités exercée(s)" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="radio-inline">
                                                            <input type="radio" name="AvoirPermis" id="radioPermisNon" value="NON"> NON
                                                            <label class="radio-inline">
                                                                <input type="radio" name="AvoirPermis" id="radioPermisOui" value="OUI" <?php if($volontaire->personne_avoir_permis=="OUI"){echo "checked" ;} ?>> OUI
                                                            </label>
                                                        </label><br>
                                                        <div id="panelPrecisionNumPermis">
                                                            <label class="control-label">N° du permis <small class="text-danger">*</small></label>
                                                            <input value="{{ $volontaire->personne_numero_permis }}" name="numeroPermis" id="numPermisInfoPers" placeholder="Entrez le numéro du permis" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4" id="panelPrecisionCatPermis">
                                                    <div class="form-group">
                                                        ...
                                                        <br>
                                                        <?php //var_dump($personneCategorie)?>
                                                        <?php foreach ($categPermis as $categoPermi):?>
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" name="categoriePermis[]" value=" <?php echo $categoPermi['idCategorie']?>" id="cbPermisCatA" <?php if(in_array($categoPermi['idCategorie'] , $personneCategorie)){ echo "checked" ;} ?> >
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="{{ $volontaire->personne_nom_pere }}" name="nomPereVolontaire" id="nomPere" placeholder="Entrez le nom du père" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label class="control-label">Prénom(s) du père <small class="text-danger">*</small></label>
                                                        <input value="{{ $volontaire->personne_prenom_pere }}" name="prenomPereVolontaire" id="prenomPere" placeholder="Entrez le prénom du père" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="nationalitePere" id="paysNationnalite" class="form-control selectpicker" data-style="btn btn-link">
                                                           @foreach ($paysMere as $pays)
                                                                <option value="<?php echo $pays['PAYS_CODE']?>" <?php if($pays['PAYS_CODE'] == $volontaire->personne_nationalite_pere){ echo "selected" ;} ?> > <?php echo $pays['PAYS_NOM']?> </option>
                                                            @endforeach
                                                        </select>
                                                        <label class="checkbox-inline">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="{{ $volontaire->personne_nom_mere }}" name="nomMereVolontaire" id="nomMere" placeholder="Entrez le prénom de la mère" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label class="control-label">Prénom(s) de la mère <small class="text-danger">*</small></label>
                                                        <input value="{{ $volontaire->personne_prenom_mere }}" type="text" name="prenomMereVolontaire" id="prenomMere" placeholder="Entrez le prénom de la mère" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="nationaliteMere" id="paysNationnalite" class="form-control selectpicker" data-style="btn btn-link">
                                                            ...
                                                            @foreach ($paysMere as $pays)
                                                                <option value="<?php echo $pays['PAYS_CODE']?>" <?php if($pays['PAYS_CODE'] == $volontaire->personne_nationalite_mere){ echo "selected" ;} ?> ><?php echo $pays['PAYS_NOM']?></option>
                                                            @endforeach
                                                        </select>
                                                        <label class="checkbox-inline">
                                        ...
                                        <div class="tab-pane" id="contactUrgence">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label class="control-label">Nom <small class="text-danger">*</small></label>
                                                        <input value="{{ $volontaire->personne_nom_urgence }}" name="nomPersUrgence" id="nomUrgence" placeholder="Entrez le nom" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label class="control-label">Prénom(s) <small class="text-danger">*</small></label>
                                                        <input value="{{ $volontaire->personne_prenom_urgence }}" name="prenomPersUrgence" type="text" id="prenomUrgence" placeholder="Entrez le prénom" class="form-control">
                                                    </div>
                                                </div>
                                                <!--<div class="col-sm-4">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="{{ $volontaire->personne_quartier_urgence }}" name="quartierUrgence" id="quartierUrgence" placeholder="Entrez la commune ou le quartier" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <!--<div class="col-sm-3">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="{{ $volontaire->personne_tel_urgence }}" name="telPersUrgence" type="tel" id="tel1Urgence" placeholder="Entrez le numero de téléphone 1" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label class="control-label">Téléphone 2 <!--<small class="text-danger">*</small>--></label>
                                                        <input value="" name="telPersUrgence" type="tel" id="tel2Urgence" placeholder="Entrez le numero de téléphone 2" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
